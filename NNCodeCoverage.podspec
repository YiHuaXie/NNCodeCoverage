...
Pod::Spec.new do |s|
  ...
  s.version          = '1.0.0'
  s.summary          = 'A short description of NNCodeCoverage.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/NeroXie/NNCodeCoverage'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'NeroXie' => 'xyh30902@163.com' }
  s.source           = { :git => 'https://github.com/NeroXie/NNCodeCoverage.git', :tag => s.version.to_s }
